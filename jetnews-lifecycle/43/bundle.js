...
(function (factory) {
  ...
  initMetadataForClass(Number_1, 'Number');
  initMetadataForClass(Bool, 'Bool');
  ...
  initMetadataForObject(DootahScreen_com_example_jetnews_glance_ui_PostDescription, 'DootahScreen_com_example_jetnews_glance_ui_PostDescription');
  ...
  initMetadataForObject(DootahScreen_com_example_jetnews_ui_home_PostCardTopPreviews, 'DootahScreen_com_example_jetnews_ui_home_PostCardTopPreviews');
  ...
  initMetadataForObject(DootahScreen_com_example_jetnews_ui_JetNewsLogo, 'DootahScreen_com_example_jetnews_ui_JetNewsLogo');
  ...
  initMetadataForObject(DootahScreen_com_example_jetnews_ui_home_AuthorAndReadTime, 'DootahScreen_com_example_jetnews_ui_home_AuthorAndReadTime');
  //endregion
  ...
  function envelope(ui, commands) {
    var tmp = '{"ui":' + toJson_1(ui) + ',"commands":[';
  ...
  function InvokeCallback(name, arguments_0) {
    arguments_0 = arguments_0 === VOID ? emptyList() : arguments_0;
    this.t4_1 = name;
    this.u4_1 = arguments_0;
  }
  protoOf(InvokeCallback).toString = function () {
    return 'InvokeCallback(name=' + this.t4_1 + ', arguments=' + toString_1(this.u4_1) + ')';
  };
  protoOf(InvokeCallback).hashCode = function () {
    var result = getStringHashCode(this.t4_1);
    result = imul(result, 31) + hashCode_0(this.u4_1) | 0;
    return result;
  };
  ...
  protoOf(Text).toString = function () {
    return 'Text(value=' + this.v4_1 + ')';
  };
  protoOf(Text).hashCode = function () {
    return getStringHashCode(this.v4_1);
  };
  ...
  function toJson(_this__u8e3s4) {
    ...
    if (_this__u8e3s4 instanceof InvokeCallback) {
      var tmp_0 = '{"type":"invokeCallback","name":"' + escapeJson(_this__u8e3s4.t4_1) + '"' + ',"arguments":[';
      tmp = tmp_0 + joinToString_0(_this__u8e3s4.u4_1, ',', VOID, VOID, VOID, VOID, toJson$lambda) + ']}';
    } else {
      if (_this__u8e3s4 instanceof Log) {
        tmp = '{"type":"log","message":"' + escapeJson(_this__u8e3s4.x4_1) + '"}';
      } else {
        if (_this__u8e3s4 instanceof Toast) {
          tmp = '{"type":"toast","message":"' + escapeJson(_this__u8e3s4.w4_1) + '"}';
        } else {
  ...
  function toJson_0(_this__u8e3s4) {
    ...
    if (_this__u8e3s4 instanceof Text) {
      tmp = '"' + escapeJson(_this__u8e3s4.v4_1) + '"';
    } else {
      if (_this__u8e3s4 instanceof Number_1) {
        tmp = _this__u8e3s4.z4_1.toString();
      } else {
        if (_this__u8e3s4 instanceof Bool) {
          tmp = _this__u8e3s4.y4_1.toString();
        } else {
          noWhenBranchMatchedException();
        }
      }
  ...
  protoOf(ScreenArguments).c5 = function (name) {
    var tmp = read(this, name, 'String');
    var tmp0_elvis_lhs = (!(tmp == null) ? typeof tmp === 'string' : false) ? tmp : null;
    var tmp_0;
    if (tmp0_elvis_lhs == null) {
      missing(this, name, 'String');
    } else {
      tmp_0 = tmp0_elvis_lhs;
    }
    return tmp_0;
  };
  protoOf(ScreenArguments).d5 = function (name) {
  ...
  function read_0($this, name) {
    ...
    return $this.e5_1.o(name);
  }
  function wrongType($this, name, type) {
    throw IllegalStateException_init_$Create$_0("Dootah screen state '" + name + "' is not a " + type);
  }
  function ScreenState() {
    this.e5_1 = HashMap_init_$Create$();
  }
  protoOf(ScreenState).f5 = function (name, initial) {
    return initialize(this, name, initial);
  };
  protoOf(ScreenState).d5 = function (name) {
    var tmp = read_0(this, name);
    var tmp0_elvis_lhs = (!(tmp == null) ? typeof tmp === 'boolean' : false) ? tmp : null;
    var tmp_0;
    if (tmp0_elvis_lhs == null) {
      wrongType(this, name, 'Boolean');
    } else {
      tmp_0 = tmp0_elvis_lhs;
    }
    return tmp_0;
  };
  protoOf(ScreenState).g5 = function (name, value) {
    // Inline function 'kotlin.collections.set' call
    this.e5_1.o1(name, value);
  };
  function Inherited() {
  }
  ...
  protoOf(Padding).toString = function () {
    return 'Padding(start=' + this.h5_1.toString() + ', top=' + this.i5_1.toString() + ', end=' + this.j5_1.toString() + ', bottom=' + this.k5_1.toString() + ')';
  };
  protoOf(Padding).hashCode = function () {
    var result = this.h5_1.hashCode();
    result = imul(result, 31) + this.i5_1.hashCode() | 0;
    result = imul(result, 31) + this.j5_1.hashCode() | 0;
    result = imul(result, 31) + this.k5_1.hashCode() | 0;
    return result;
  };
  protoOf(Padding).equals = function (other) {
    ...
    if (!this.i5_1.equals(other.i5_1))
      return false;
    if (!this.j5_1.equals(other.j5_1))
      return false;
    if (!this.k5_1.equals(other.k5_1))
      return false;
    return true;
  };
  ...
  function ColumnNode(modifiers, horizontalAlignment, verticalArrangement, children) {
    ...
    this.l5_1 = modifiers;
    this.m5_1 = horizontalAlignment;
    this.n5_1 = verticalArrangement;
    this.o5_1 = children;
  }
  protoOf(ColumnNode).toString = function () {
    return 'ColumnNode(modifiers=' + toString_1(this.l5_1) + ', horizontalAlignment=' + this.m5_1 + ', verticalArrangement=' + toString_0(this.n5_1) + ', children=' + toString_1(this.o5_1) + ')';
  };
  protoOf(ColumnNode).hashCode = function () {
    var result = hashCode_0(this.l5_1);
    result = imul(result, 31) + (this.m5_1 == null ? 0 : getStringHashCode(this.m5_1)) | 0;
    result = imul(result, 31) + (this.n5_1 == null ? 0 : this.n5_1.hashCode()) | 0;
    result = imul(result, 31) + hashCode_0(this.o5_1) | 0;
    return result;
  };
  protoOf(ColumnNode).equals = function (other) {
    ...
    if (!equals(this.l5_1, other.l5_1))
      return false;
    if (!(this.m5_1 == other.m5_1))
      return false;
    if (!equals(this.n5_1, other.n5_1))
      return false;
    if (!equals(this.o5_1, other.o5_1))
      return false;
    return true;
  };
  ...
  protoOf(ButtonNode).toString = function () {
    return 'ButtonNode(text=' + this.p5_1 + ', action=' + this.q5_1 + ', modifiers=' + toString_1(this.r5_1) + ')';
  };
  protoOf(ButtonNode).hashCode = function () {
    var result = getStringHashCode(this.p5_1);
    result = imul(result, 31) + getStringHashCode(this.q5_1) | 0;
  ...
  protoOf(ButtonNode).equals = function (other) {
    ...
    if (!(other instanceof ButtonNode))
      return false;
    if (!(this.p5_1 === other.p5_1))
      return false;
    if (!(this.q5_1 === other.q5_1))
      return false;
  ...
  protoOf(TextNode).toString = function () {
    return 'TextNode(text=' + this.s5_1 + ', modifiers=' + toString_1(this.t5_1) + ')';
  };
  protoOf(TextNode).hashCode = function () {
    var result = getStringHashCode(this.s5_1);
    result = imul(result, 31) + hashCode_0(this.t5_1) | 0;
    return result;
  };
  protoOf(TextNode).equals = function (other) {
    ...
    if (!(other instanceof TextNode))
      return false;
    if (!(this.s5_1 === other.s5_1))
      return false;
    if (!equals(this.t5_1, other.t5_1))
      return false;
    return true;
  };
  ...
  protoOf(ComponentNode).toString = function () {
    return 'ComponentNode(adapter=' + this.u5_1 + ', props=' + toString_1(this.v5_1) + ', children=' + toString_1(this.w5_1) + ', entries=' + toString_1(this.x5_1) + ')';
  };
  protoOf(ComponentNode).hashCode = function () {
    var result = getStringHashCode(this.u5_1);
    result = imul(result, 31) + hashCode_0(this.v5_1) | 0;
    result = imul(result, 31) + hashCode_0(this.w5_1) | 0;
  ...
  protoOf(ComponentNode).equals = function (other) {
    ...
    if (!(this.u5_1 === other.u5_1))
      return false;
    if (!equals(this.v5_1, other.v5_1))
      return false;
    if (!equals(this.w5_1, other.w5_1))
      return false;
  ...
  protoOf(DimensionNode).toString = function () {
    return 'DimensionNode(value=' + this.y5_1 + ', anchor=' + this.z5_1 + ')';
  };
  protoOf(DimensionNode).hashCode = function () {
    var result = this.y5_1 == null ? 0 : getNumberHashCode(this.y5_1);
    result = imul(result, 31) + (this.z5_1 == null ? 0 : getStringHashCode(this.z5_1)) | 0;
    return result;
  };
  protoOf(DimensionNode).equals = function (other) {
    ...
    if (!(other instanceof DimensionNode))
      return false;
    if (!equals(this.y5_1, other.y5_1))
      return false;
  ...
  protoOf(Region).toString = function () {
    return 'Region(adapter=' + this.a6_1 + ')';
  };
  ...
  function RowNode(modifiers, verticalAlignment, horizontalArrangement, children) {
    ...
    children = children === VOID ? emptyList() : children;
    this.b6_1 = modifiers;
    this.c6_1 = verticalAlignment;
    this.d6_1 = horizontalArrangement;
    this.e6_1 = children;
  }
  protoOf(RowNode).toString = function () {
    return 'RowNode(modifiers=' + toString_1(this.b6_1) + ', verticalAlignment=' + this.c6_1 + ', horizontalArrangement=' + toString_0(this.d6_1) + ', children=' + toString_1(this.e6_1) + ')';
  };
  protoOf(RowNode).hashCode = function () {
    var result = hashCode_0(this.b6_1);
    result = imul(result, 31) + (this.c6_1 == null ? 0 : getStringHashCode(this.c6_1)) | 0;
    result = imul(result, 31) + (this.d6_1 == null ? 0 : this.d6_1.hashCode()) | 0;
    result = imul(result, 31) + hashCode_0(this.e6_1) | 0;
    return result;
  };
  protoOf(RowNode).equals = function (other) {
    ...
    if (!(other instanceof RowNode))
      return false;
    if (!equals(this.b6_1, other.b6_1))
      return false;
    if (!(this.c6_1 == other.c6_1))
      return false;
    if (!equals(this.d6_1, other.d6_1))
      return false;
    if (!equals(this.e6_1, other.e6_1))
      return false;
    return true;
  };
  ...
  protoOf(FragmentNode).toString = function () {
    return 'FragmentNode(children=' + toString_1(this.f6_1) + ')';
  };
  ...
  protoOf(FragmentNode).equals = function (other) {
    ...
    if (!(other instanceof FragmentNode))
      return false;
    if (!equals(this.f6_1, other.f6_1))
      return false;
    return true;
  };
  function BoxNode() {
  ...
  function toJson_1(_this__u8e3s4) {
    ...
    if (_this__u8e3s4 instanceof ColumnNode) {
      tmp = container('column', _this__u8e3s4.l5_1, _this__u8e3s4.o5_1, alignmentField('horizontalAlignment', _this__u8e3s4.m5_1) + arrangementField('verticalArrangement', _this__u8e3s4.n5_1));
    } else {
      if (_this__u8e3s4 instanceof RowNode) {
        tmp = container('row', _this__u8e3s4.b6_1, _this__u8e3s4.e6_1, alignmentField('verticalAlignment', _this__u8e3s4.c6_1) + arrangementField('horizontalArrangement', _this__u8e3s4.d6_1));
      } else {
        if (_this__u8e3s4 instanceof BoxNode) {
          tmp = container('box', _this__u8e3s4.g6_1, _this__u8e3s4.i6_1, alignmentField('contentAlignment', _this__u8e3s4.h6_1));
        } else {
          if (_this__u8e3s4 instanceof TextNode) {
            tmp = '{"type":"text","text":"' + escapeJson(_this__u8e3s4.s5_1) + '"' + modifiersField(_this__u8e3s4.t5_1) + '}';
          } else {
            if (_this__u8e3s4 instanceof ButtonNode) {
              tmp = '{"type":"button","text":"' + escapeJson(_this__u8e3s4.p5_1) + '",' + ('"action":"' + escapeJson(_this__u8e3s4.q5_1) + '"') + modifiersField(_this__u8e3s4.r5_1) + '}';
            } else {
              if (_this__u8e3s4 instanceof ComponentNode) {
                tmp = '{"type":"component","adapter":"' + escapeJson(_this__u8e3s4.u5_1) + '"' + propsField(_this__u8e3s4.v5_1) + slotsField(_this__u8e3s4.w5_1) + entriesField(_this__u8e3s4.x5_1) + '}';
              } else {
                if (_this__u8e3s4 instanceof FragmentNode) {
                  tmp = '{"type":"fragment","children":[' + joinToString_0(_this__u8e3s4.f6_1, ',', VOID, VOID, VOID, VOID, toJson$lambda_0) + ']}';
                } else {
                  noWhenBranchMatchedException();
                }
              }
  ...
  function arrangementField(name, arrangement) {
    if (arrangement == null)
      return '';
    var tmp0_safe_receiver = arrangement.k6_1;
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
      // Inline function 'kotlin.let' call
      tmp = ',"space":' + toJson_2(tmp0_safe_receiver);
    }
    var tmp1_elvis_lhs = tmp;
    var spacing = tmp1_elvis_lhs == null ? '' : tmp1_elvis_lhs;
    return ',"' + name + '":{"token":"' + escapeJson(arrangement.j6_1) + '"' + spacing + '}';
  }
  ...
  function toJson_2(_this__u8e3s4) {
    return !(_this__u8e3s4.z5_1 == null) ? '{"anchor":"' + escapeJson(_this__u8e3s4.z5_1) + '"}' : '' + _this__u8e3s4.y5_1;
  }
  function toJson_3(_this__u8e3s4) {
    ...
    if (_this__u8e3s4 instanceof Inherited) {
      ...
      if (_this__u8e3s4 instanceof Padding) {
        tmp = '{"type":"padding","start":' + toJson_2(_this__u8e3s4.h5_1) + ',"top":' + toJson_2(_this__u8e3s4.i5_1) + ',' + ('"end":' + toJson_2(_this__u8e3s4.j5_1) + ',"bottom":' + toJson_2(_this__u8e3s4.k5_1) + '}');
      } else {
        if (_this__u8e3s4 instanceof FillMaxWidth) {
          tmp = '{"type":"fillMaxWidth","fraction":' + _this__u8e3s4.t6_1 + '}';
        } else {
          if (_this__u8e3s4 instanceof FillMaxHeight) {
            tmp = '{"type":"fillMaxHeight","fraction":' + _this__u8e3s4.s6_1 + '}';
          } else {
            if (_this__u8e3s4 instanceof FillMaxSize) {
              tmp = '{"type":"fillMaxSize","fraction":' + _this__u8e3s4.r6_1 + '}';
            } else {
              if (_this__u8e3s4 instanceof Size) {
                tmp = '{"type":"size","width":' + toJson_2(_this__u8e3s4.p6_1) + ',"height":' + toJson_2(_this__u8e3s4.q6_1) + '}';
              } else {
                if (_this__u8e3s4 instanceof Width) {
                  tmp = '{"type":"width","value":' + toJson_2(_this__u8e3s4.o6_1) + '}';
                } else {
                  if (_this__u8e3s4 instanceof Height) {
                    tmp = '{"type":"height","value":' + toJson_2(_this__u8e3s4.n6_1) + '}';
                  } else {
                    if (_this__u8e3s4 instanceof Weight) {
                      tmp = '{"type":"weight","value":' + _this__u8e3s4.m6_1 + '}';
                    } else {
                      if (_this__u8e3s4 instanceof Background) {
                        tmp = '{"type":"background","color":' + _this__u8e3s4.l6_1.toString() + '}';
                      } else {
                        noWhenBranchMatchedException();
                      }
                    }
  ...
  function toJson_4(_this__u8e3s4) {
    ...
    if (_this__u8e3s4 instanceof NullProp) {
      ...
      if (_this__u8e3s4 instanceof BoolProp) {
        tmp = '{"k":"bool","v":' + _this__u8e3s4.m7_1 + '}';
      } else {
        if (_this__u8e3s4 instanceof IntProp) {
          tmp = '{"k":"int","v":' + _this__u8e3s4.l7_1 + '}';
        } else {
          if (_this__u8e3s4 instanceof LongProp) {
            tmp = '{"k":"long","v":"' + escapeJson(_this__u8e3s4.k7_1) + '"}';
          } else {
            if (_this__u8e3s4 instanceof FloatProp) {
              tmp = '{"k":"float","v":' + _this__u8e3s4.j7_1 + '}';
            } else {
              if (_this__u8e3s4 instanceof DoubleProp) {
                tmp = '{"k":"double","v":' + _this__u8e3s4.i7_1 + '}';
              } else {
                if (_this__u8e3s4 instanceof StringProp) {
                  tmp = '{"k":"string","v":"' + escapeJson(_this__u8e3s4.h7_1) + '"}';
                } else {
                  if (_this__u8e3s4 instanceof DpProp) {
                    tmp = '{"k":"dp","v":' + _this__u8e3s4.g7_1 + '}';
                  } else {
                    if (_this__u8e3s4 instanceof AnchorProp) {
                      tmp = '{"k":"anchor","v":"' + escapeJson(_this__u8e3s4.f7_1) + '"}';
                    } else {
                      if (_this__u8e3s4 instanceof ColorProp) {
                        tmp = '{"k":"color","v":' + _this__u8e3s4.e7_1.toString() + '}';
                      } else {
                        if (_this__u8e3s4 instanceof ThemeColorProp) {
                          tmp = '{"k":"themeColor","token":"' + escapeJson(_this__u8e3s4.d7_1) + '"}';
                        } else {
                          if (_this__u8e3s4 instanceof ShapeProp) {
                            tmp = '{"k":"shape","token":"' + escapeJson(_this__u8e3s4.c7_1) + '"}';
                          } else {
                            if (_this__u8e3s4 instanceof PainterResourceProp) {
                              tmp = '{"k":"painterRes","key":"' + escapeJson(_this__u8e3s4.b7_1) + '"}';
                            } else {
                              if (_this__u8e3s4 instanceof StringResourceProp) {
                                tmp = '{"k":"stringRes","key":"' + escapeJson(_this__u8e3s4.a7_1) + '"}';
                              } else {
                                if (_this__u8e3s4 instanceof ModifierProp) {
                                  tmp = '{"k":"modifier","ops":[' + joinToString_0(_this__u8e3s4.z6_1, ',', VOID, VOID, VOID, VOID, toJson$lambda_1) + ']}';
                                } else {
                                  if (_this__u8e3s4 instanceof ListProp) {
                                    tmp = '{"k":"list","items":[' + joinToString_0(_this__u8e3s4.y6_1, ',', VOID, VOID, VOID, VOID, toJson$lambda_2) + ']}';
                                  } else {
                                    if (_this__u8e3s4 instanceof HandleProp) {
                                      tmp = '{"k":"handle","name":"' + escapeJson(_this__u8e3s4.x6_1) + '"}';
                                    } else {
                                      if (_this__u8e3s4 instanceof StateProp) {
                                        tmp = '{"k":"state","name":"' + escapeJson(_this__u8e3s4.w6_1) + '"}';
                                      } else {
                                        if (_this__u8e3s4 instanceof CallbackProp) {
                                          tmp = '{"k":"callback","id":"' + escapeJson(_this__u8e3s4.u6_1) + '","arity":' + _this__u8e3s4.v6_1 + '}';
                                        } else {
                                          noWhenBranchMatchedException();
                                        }
                                      }
  ...
  function toJson_5(_this__u8e3s4) {
    ...
    if (_this__u8e3s4 instanceof Item) {
      tmp = '{"kind":"item","children":[' + joinToString_0(_this__u8e3s4.n7_1, ',', VOID, VOID, VOID, VOID, toJson$lambda_3) + ']}';
    } else {
      if (_this__u8e3s4 instanceof Region) {
        tmp = '{"kind":"region","adapter":"' + escapeJson(_this__u8e3s4.a6_1) + '"}';
      } else {
        noWhenBranchMatchedException();
      }
    }
  ...
  function toJson_6(_this__u8e3s4) {
    var tmp = '{"op":"' + escapeJson(_this__u8e3s4.o7_1) + '"';
    var tmp_0;
    if (_this__u8e3s4.p7_1.h()) {
      tmp_0 = '';
    } else {
      var tmp_1 = _this__u8e3s4.p7_1.p();
      tmp_0 = ',"args":{' + joinToString_0(tmp_1, ',', VOID, VOID, VOID, VOID, toJson$lambda_4) + '}';
    }
    return tmp + tmp_0 + '}';
  }
  ...
  function propsField$lambda(_destruct__k2r9zo) {
    ...
    return '"' + escapeJson(name) + '":' + toJson_4(value);
  }
  ...
  function toJson$lambda_3(it) {
    return toJson_1(it);
  }
  function toJson$lambda_4(_destruct__k2r9zo) {
    // Inline function 'kotlin.collections.component1' call
    var name = _destruct__k2r9zo.l();
    // Inline function 'kotlin.collections.component2' call
    var value = _destruct__k2r9zo.m();
  ...
  protoOf(CallbackProp).toString = function () {
    return 'CallbackProp(id=' + this.u6_1 + ', arity=' + this.v6_1 + ')';
  };
  protoOf(CallbackProp).hashCode = function () {
    var result = getStringHashCode(this.u6_1);
    result = imul(result, 31) + this.v6_1 | 0;
    return result;
  };
  ...
  protoOf(PainterResourceProp).toString = function () {
    return 'PainterResourceProp(key=' + this.b7_1 + ')';
  };
  ...
  protoOf(StringResourceProp).toString = function () {
    return 'StringResourceProp(key=' + this.a7_1 + ')';
  };
  ...
  protoOf(HandleProp).toString = function () {
    return 'HandleProp(name=' + this.x6_1 + ')';
  };
  ...
  function ModifierProp(operations) {
    ...
    this.z6_1 = operations;
  }
  protoOf(ModifierProp).toString = function () {
    return 'ModifierProp(operations=' + toString_1(this.z6_1) + ')';
  };
  protoOf(ModifierProp).hashCode = function () {
    return hashCode_0(this.z6_1);
  };
  ...
  protoOf(ModifierOpNode).toString = function () {
    return 'ModifierOpNode(op=' + this.o7_1 + ', arguments=' + toString_1(this.p7_1) + ')';
  };
  protoOf(ModifierOpNode).hashCode = function () {
    var result = getStringHashCode(this.o7_1);
    result = imul(result, 31) + hashCode_0(this.p7_1) | 0;
    return result;
  };
  protoOf(ModifierOpNode).equals = function (other) {
    ...
    if (!(other instanceof ModifierOpNode))
      return false;
    if (!(this.o7_1 === other.o7_1))
      return false;
    if (!equals(this.p7_1, other.p7_1))
      return false;
    return true;
  };
  ...
  protoOf(DpProp).toString = function () {
    return 'DpProp(value=' + this.g7_1 + ')';
  };
  protoOf(DpProp).hashCode = function () {
    return getNumberHashCode(this.g7_1);
  };
  ...
  protoOf(BoolProp).toString = function () {
    return 'BoolProp(value=' + this.m7_1 + ')';
  };
  protoOf(BoolProp).hashCode = function () {
    return getBooleanHashCode(this.m7_1);
  };
  ...
  protoOf(AnchorProp).toString = function () {
    return 'AnchorProp(anchor=' + this.f7_1 + ')';
  };
  protoOf(AnchorProp).hashCode = function () {
    return getStringHashCode(this.f7_1);
  };
  ...
  protoOf(ThemeColorProp).toString = function () {
    return 'ThemeColorProp(token=' + this.d7_1 + ')';
  };
  protoOf(ThemeColorProp).hashCode = function () {
    return getStringHashCode(this.d7_1);
  };
  ...
  function DootahScreen_com_example_jetnews_ui_home_PostListPopularSection() {
    this.q7_1 = 'com.example.jetnews.ui.home.PostListPopularSection';
  }
  protoOf(DootahScreen_com_example_jetnews_ui_home_PostListPopularSection).r7 = function (arguments_0, state) {
    state.f5('showReadingTip', false);
    var tmp = emptyList();
    // Inline function 'kotlin.collections.buildList' call
    // Inline function 'kotlin.collections.buildListInternal' call
    // Inline function 'kotlin.apply' call
    var this_0 = ArrayList_init_$Create$();
    this_0.f1(new ButtonNode('Reading tip', 'reading-tip'));
    if (state.d5('showReadingTip')) {
      this_0.f1(new TextNode('Swipe the cards to explore popular stories.'));
    } else {
      this_0.f1(new TextNode("Reading tip: explore today's popular stories."));
    }
    this_0.f1(new ButtonNode('Read now', 'read-now'));
  ...
  protoOf(DootahScreen_com_example_jetnews_ui_home_PostListPopularSection).s7 = function (action, arguments_0, state) {
    // Inline function 'kotlin.collections.mutableListOf' call
    var commands = ArrayList_init_$Create$();
    state.f5('showReadingTip', false);
    if (action === 'reading-tip') {
      state.g5('showReadingTip', !state.d5('showReadingTip'));
    } else if (action === 'read-now') {
      commands.f1(new InvokeCallback('navigateToPost', listOf(new Text('7446d8dfd7dc'))));
    }
    return commands;
  };
  var DootahScreen_com_example_jetnews_ui_home_PostListPopularSection_instance;
  function DootahScreen_com_example_jetnews_ui_home_PostListPopularSection_getInstance() {
  ...
  function DootahScreen_com_example_jetnews_ui_utils_FavoriteButton() {
    this.t7_1 = 'com.example.jetnews.ui.utils.FavoriteButton';
  }
  protoOf(DootahScreen_com_example_jetnews_ui_utils_FavoriteButton).r7 = function (arguments_0, state) {
    var tmp = mapOf(to('onClick', new CallbackProp('onClick()', 0)));
    // Inline function 'kotlin.collections.buildList' call
    // Inline function 'kotlin.collections.buildListInternal' call
    // Inline function 'kotlin.apply' call
    var this_0 = ArrayList_init_$Create$();
    this_0.f1(new ComponentNode('androidx.compose.material3.Icon(contentDescription|modifier|painter|tint)', mapOf_0([to('painter', new PainterResourceProp('drawable:ic_thumb_up')), to('contentDescription', new StringResourceProp('string:cd_add_to_favorites'))])));
    var tmp$ret$0 = this_0.a2();
  ...
  protoOf(DootahScreen_com_example_jetnews_ui_utils_FavoriteButton).s7 = function (action, arguments_0, state) {
    // Inline function 'kotlin.collections.mutableListOf' call
    var commands = ArrayList_init_$Create$();
    return commands;
  };
  var DootahScreen_com_example_jetnews_ui_utils_FavoriteButton_instance;
  function DootahScreen_com_example_jetnews_ui_utils_FavoriteButton_getInstance() {
  ...
  function DootahScreen_com_example_jetnews_glance_ui_PostDescription() {
    this.u7_1 = 'com.example.jetnews.glance.ui.PostDescription';
  }
  protoOf(DootahScreen_com_example_jetnews_glance_ui_PostDescription).r7 = function (arguments_0, state) {
    var title = arguments_0.c5('title');
    var metadata = arguments_0.c5('metadata');
    var tmp = mapOf(to('modifier', new HandleProp('modifier')));
    // Inline function 'kotlin.collections.buildList' call
    // Inline function 'kotlin.collections.buildListInternal' call
    // Inline function 'kotlin.apply' call
    var this_0 = ArrayList_init_$Create$();
    this_0.f1(new ComponentNode('!androidx.glance.text.Text@1otm0sxl0c2qi'));
    this_0.f1(new ComponentNode('!androidx.glance.layout.Spacer@0gjfb9amxmauh'));
    this_0.f1(new ComponentNode('!androidx.glance.text.Text@17d9asxd7nt4u'));
    var tmp$ret$0 = this_0.a2();
  ...
  protoOf(DootahScreen_com_example_jetnews_glance_ui_PostDescription).s7 = function (action, arguments_0, state) {
    // Inline function 'kotlin.collections.mutableListOf' call
    var commands = ArrayList_init_$Create$();
    var title = arguments_0.c5('title');
    var metadata = arguments_0.c5('metadata');
  ...
  var DootahScreen_com_example_jetnews_glance_ui_PostDescription_instance;
  function DootahScreen_com_example_jetnews_glance_ui_PostDescription_getInstance() {
  ...
  function DootahScreen_com_example_jetnews_ui_interests_SelectTopicButtonPreviewTemplate() {
    this.v7_1 = 'com.example.jetnews.ui.interests.SelectTopicButtonPreviewTemplate';
  }
  protoOf(DootahScreen_com_example_jetnews_ui_interests_SelectTopicButtonPreviewTemplate).r7 = function (arguments_0, state) {
    var selected = arguments_0.d5('selected');
    // Inline function 'kotlin.collections.buildList' call
    // Inline function 'kotlin.collections.buildListInternal' call
    // Inline function 'kotlin.apply' call
    var this_0 = ArrayList_init_$Create$();
  ...
  protoOf(DootahScreen_com_example_jetnews_ui_interests_SelectTopicButtonPreviewTemplate).s7 = function (action, arguments_0, state) {
    // Inline function 'kotlin.collections.mutableListOf' call
    var commands = ArrayList_init_$Create$();
    var selected = arguments_0.d5('selected');
    return commands;
  };
  var DootahScreen_com_example_jetnews_ui_interests_SelectTopicButtonPreviewTemplate_instance;
  ...
  function DootahScreen_com_example_jetnews_ui_home_PostCardTopPreviews() {
    this.w7_1 = 'com.example.jetnews.ui.home.PostCardTopPreviews';
  }
  protoOf(DootahScreen_com_example_jetnews_ui_home_PostCardTopPreviews).r7 = function (arguments_0, state) {
    // Inline function 'kotlin.collections.buildList' call
    // Inline function 'kotlin.collections.buildListInternal' call
    // Inline function 'kotlin.apply' call
    var this_0 = ArrayList_init_$Create$();
    ...
    // Inline function 'kotlin.apply' call
    var this_1 = ArrayList_init_$Create$();
    this_1.f1(new ComponentNode('!com.example.jetnews.ui.home.PostCardTop@14x5ev8sid9i5'));
    var tmp$ret$4 = this_1.a2();
    this_0.f1(new ComponentNode('androidx.compose.material3.Surface(border|color|content|contentColor|modifier|shadowElevation|shape|tonalElevation)', VOID, mapOf(to('content', tmp$ret$4))));
    var tmp$ret$0 = this_0.a2();
    return new ComponentNode('com.example.jetnews.ui.theme.JetnewsTheme(content|darkTheme)', VOID, mapOf(to('content', tmp$ret$0)));
  };
  protoOf(DootahScreen_com_example_jetnews_ui_home_PostCardTopPreviews).s7 = function (action, arguments_0, state) {
    // Inline function 'kotlin.collections.mutableListOf' call
    var commands = ArrayList_init_$Create$();
    return commands;
  };
  var DootahScreen_com_example_jetnews_ui_home_PostCardTopPreviews_instance;
  function DootahScreen_com_example_jetnews_ui_home_PostCardTopPreviews_getInstance() {
    return DootahScreen_com_example_jetnews_ui_home_PostCardTopPreviews_instance;
  }
  function get_screenStates() {
    _init_properties_13_kt__uy76e6();
    return screenStates;
  }
  var screenStates;
  function screenIds() {
  ...
  function renderOf(screenId, arguments_0, state) {
    ...
    switch (screenId) {
      case 'com.example.jetnews.glance.ui.PostDescription':
        return DootahScreen_com_example_jetnews_glance_ui_PostDescription_instance.r7(arguments_0, state);
      case 'com.example.jetnews.ui.JetNewsLogo':
        return DootahScreen_com_example_jetnews_ui_JetNewsLogo_instance.r7(arguments_0, state);
      case 'com.example.jetnews.ui.home.AuthorAndReadTime':
        return DootahScreen_com_example_jetnews_ui_home_AuthorAndReadTime_instance.r7(arguments_0, state);
      case 'com.example.jetnews.ui.home.PostCardTopPreviews':
        return DootahScreen_com_example_jetnews_ui_home_PostCardTopPreviews_instance.r7(arguments_0, state);
      case 'com.example.jetnews.ui.home.PostListPopularSection':
        return DootahScreen_com_example_jetnews_ui_home_PostListPopularSection_instance.r7(arguments_0, state);
      case 'com.example.jetnews.ui.home.PostListTopSection':
        return DootahScreen_com_example_jetnews_ui_home_PostListTopSection_instance.r7(arguments_0, state);
      case 'com.example.jetnews.ui.interests.SelectTopicButtonPreviewTemplate':
        return DootahScreen_com_example_jetnews_ui_interests_SelectTopicButtonPreviewTemplate_instance.r7(arguments_0, state);
      case 'com.example.jetnews.ui.interests.TopicItem':
        return DootahScreen_com_example_jetnews_ui_interests_TopicItem_instance.r7(arguments_0, state);
      case 'com.example.jetnews.ui.post.FunctionalityNotAvailablePopup':
        return DootahScreen_com_example_jetnews_ui_post_FunctionalityNotAvailablePopup_instance.r7(arguments_0, state);
      case 'com.example.jetnews.ui.post.PostContent':
        return DootahScreen_com_example_jetnews_ui_post_PostContent_instance.r7(arguments_0, state);
      case 'com.example.jetnews.ui.utils.FavoriteButton':
        return DootahScreen_com_example_jetnews_ui_utils_FavoriteButton_instance.r7(arguments_0, state);
      case 'com.example.jetnews.ui.utils.ShareButton':
        return DootahScreen_com_example_jetnews_ui_utils_ShareButton_instance.r7(arguments_0, state);
      case 'com.example.jetnews.ui.utils.TextSettingsButton':
        return DootahScreen_com_example_jetnews_ui_utils_TextSettingsButton_instance.r7(arguments_0, state);
      default:
        return null;
    }
  }
  function performOn(screenId, action, arguments_0, state) {
    ...
    switch (screenId) {
      case 'com.example.jetnews.glance.ui.PostDescription':
        return DootahScreen_com_example_jetnews_glance_ui_PostDescription_instance.s7(action, arguments_0, state);
      case 'com.example.jetnews.ui.JetNewsLogo':
        return DootahScreen_com_example_jetnews_ui_JetNewsLogo_instance.s7(action, arguments_0, state);
      case 'com.example.jetnews.ui.home.AuthorAndReadTime':
        return DootahScreen_com_example_jetnews_ui_home_AuthorAndReadTime_instance.s7(action, arguments_0, state);
      case 'com.example.jetnews.ui.home.PostCardTopPreviews':
        return DootahScreen_com_example_jetnews_ui_home_PostCardTopPreviews_instance.s7(action, arguments_0, state);
      case 'com.example.jetnews.ui.home.PostListPopularSection':
        return DootahScreen_com_example_jetnews_ui_home_PostListPopularSection_instance.s7(action, arguments_0, state);
      case 'com.example.jetnews.ui.home.PostListTopSection':
        return DootahScreen_com_example_jetnews_ui_home_PostListTopSection_instance.s7(action, arguments_0, state);
      case 'com.example.jetnews.ui.interests.SelectTopicButtonPreviewTemplate':
        return DootahScreen_com_example_jetnews_ui_interests_SelectTopicButtonPreviewTemplate_instance.s7(action, arguments_0, state);
      case 'com.example.jetnews.ui.interests.TopicItem':
        return DootahScreen_com_example_jetnews_ui_interests_TopicItem_instance.s7(action, arguments_0, state);
      case 'com.example.jetnews.ui.post.FunctionalityNotAvailablePopup':
        return DootahScreen_com_example_jetnews_ui_post_FunctionalityNotAvailablePopup_instance.s7(action, arguments_0, state);
      case 'com.example.jetnews.ui.post.PostContent':
        return DootahScreen_com_example_jetnews_ui_post_PostContent_instance.s7(action, arguments_0, state);
      case 'com.example.jetnews.ui.utils.FavoriteButton':
        return DootahScreen_com_example_jetnews_ui_utils_FavoriteButton_instance.s7(action, arguments_0, state);
      case 'com.example.jetnews.ui.utils.ShareButton':
        return DootahScreen_com_example_jetnews_ui_utils_ShareButton_instance.s7(action, arguments_0, state);
      case 'com.example.jetnews.ui.utils.TextSettingsButton':
        return DootahScreen_com_example_jetnews_ui_utils_TextSettingsButton_instance.s7(action, arguments_0, state);
      default:
        return null;
    }
  }
  var properties_initialized_13_kt_47bn7o;
  function _init_properties_13_kt__uy76e6() {
    if (!properties_initialized_13_kt_47bn7o) {
      properties_initialized_13_kt_47bn7o = true;
      screenStates = HashMap_init_$Create$();
    }
  }
  function DootahScreen_com_example_jetnews_ui_interests_TopicItem() {
    this.a8_1 = 'com.example.jetnews.ui.interests.TopicItem';
  }
  protoOf(DootahScreen_com_example_jetnews_ui_interests_TopicItem).r7 = function (arguments_0, state) {
    var itemTitle = arguments_0.c5('itemTitle');
    var selected = arguments_0.d5('selected');
  ...
  protoOf(DootahScreen_com_example_jetnews_ui_interests_TopicItem).s7 = function (action, arguments_0, state) {
    // Inline function 'kotlin.collections.mutableListOf' call
    var commands = ArrayList_init_$Create$();
    var itemTitle = arguments_0.c5('itemTitle');
    var selected = arguments_0.d5('selected');
  ...
  function DootahScreen_com_example_jetnews_ui_utils_TextSettingsButton() {
    this.e8_1 = 'com.example.jetnews.ui.utils.TextSettingsButton';
  }
  protoOf(DootahScreen_com_example_jetnews_ui_utils_TextSettingsButton).r7 = function (arguments_0, state) {
    var tmp = mapOf(to('onClick', new CallbackProp('onClick()', 0)));
    // Inline function 'kotlin.collections.buildList' call
    // Inline function 'kotlin.collections.buildListInternal' call
    // Inline function 'kotlin.apply' call
    var this_0 = ArrayList_init_$Create$();
    this_0.f1(new ComponentNode('androidx.compose.material3.Icon(contentDescription|modifier|painter|tint)', mapOf_0([to('painter', new PainterResourceProp('drawable:ic_text_settings')), to('contentDescription', new StringResourceProp('string:cd_text_settings'))])));
    var tmp$ret$0 = this_0.a2();
    return new ComponentNode('androidx.compose.material3.IconButton(colors|content|enabled|interactionSource|modifier|onClick|shape)', tmp, mapOf(to('content', tmp$ret$0)));
  };
  protoOf(DootahScreen_com_example_jetnews_ui_utils_TextSettingsButton).s7 = function (action, arguments_0, state) {
    // Inline function 'kotlin.collections.mutableListOf' call
    var commands = ArrayList_init_$Create$();
    return commands;
  };
  var DootahScreen_com_example_jetnews_ui_utils_TextSettingsButton_instance;
  function DootahScreen_com_example_jetnews_ui_utils_TextSettingsButton_getInstance() {
    return DootahScreen_com_example_jetnews_ui_utils_TextSettingsButton_instance;
  }
  function DootahScreen_com_example_jetnews_ui_post_PostContent() {
    this.c8_1 = 'com.example.jetnews.ui.post.PostContent';
  }
  protoOf(DootahScreen_com_example_jetnews_ui_post_PostContent).r7 = function (arguments_0, state) {
    var tmp = to('contentPadding', new HandleProp('contentPadding'));
    // Inline function 'kotlin.collections.mapOf' call
    var tmp$ret$0 = emptyMap();
    return new ComponentNode('androidx.compose.foundation.lazy.LazyColumn(content|contentPadding|flingBehavior|horizontalAlignment|modifier|overscrollEffect|reverseLayout|state|userScrollEnabled|verticalArrangement)', mapOf_0([tmp, to('modifier', new ModifierProp(listOf_0([new ModifierOpNode('inherited', tmp$ret$0), new ModifierOpNode('padding', mapOf_0([to('start', new AnchorProp('com.example.jetnews.ui.post.defaultSpacerSize')), to('top', new DpProp(0.0)), to('end', new AnchorProp('com.example.jetnews.ui.post.defaultSpacerSize')), to('bottom', new DpProp(0.0))]))]))), to('state', new HandleProp('state'))]), VOID, mapOf(to('content', listOf(new Region('!com.example.jetnews.ui.post.postContentItems@0n28bqwqgrz39')))));
  };
  protoOf(DootahScreen_com_example_jetnews_ui_post_PostContent).s7 = function (action, arguments_0, state) {
    // Inline function 'kotlin.collections.mutableListOf' call
    var commands = ArrayList_init_$Create$();
    return commands;
  };
  ...
  function DootahScreen_com_example_jetnews_ui_post_FunctionalityNotAvailablePopup() {
    this.b8_1 = 'com.example.jetnews.ui.post.FunctionalityNotAvailablePopup';
  }
  protoOf(DootahScreen_com_example_jetnews_ui_post_FunctionalityNotAvailablePopup).r7 = function (arguments_0, state) {
    var tmp = mapOf(to('onDismissRequest', new CallbackProp('onDismiss()', 0)));
    // Inline function 'kotlin.collections.buildList' call
    // Inline function 'kotlin.collections.buildListInternal' call
    // Inline function 'kotlin.apply' call
    var this_0 = ArrayList_init_$Create$();
    this_0.f1(new ComponentNode('!androidx.compose.material3.Text@0z5eo0hcul112'));
    var tmp$ret$0 = this_0.a2();
    var tmp_0 = to('text', tmp$ret$0);
    // Inline function 'kotlin.collections.buildList' call
    // Inline function 'kotlin.collections.buildListInternal' call
    // Inline function 'kotlin.apply' call
    var this_1 = ArrayList_init_$Create$();
    var tmp_1 = mapOf(to('onClick', new CallbackProp('onDismiss()', 0)));
    // Inline function 'kotlin.collections.buildList' call
    // Inline function 'kotlin.collections.buildListInternal' call
    // Inline function 'kotlin.apply' call
    var this_2 = ArrayList_init_$Create$();
    this_2.f1(new ComponentNode('androidx.compose.material3.Text(autoSize|color|fontFamily|fontSize|fontStyle|fontWeight|letterSpacing|lineHeight|maxLines|minLines|modifier|onTextLayout|overflow|softWrap|style|text|textAlign|textDecoration)', mapOf(to('text', new StringResourceProp('string:close')))));
    var tmp$ret$8 = this_2.a2();
    this_1.f1(new ComponentNode('androidx.compose.material3.TextButton(border|colors|content|contentPadding|elevation|enabled|interactionSource|modifier|onClick|shape)', tmp_1, mapOf(to('content', tmp$ret$8))));
    var tmp$ret$4 = this_1.a2();
  ...
  protoOf(DootahScreen_com_example_jetnews_ui_post_FunctionalityNotAvailablePopup).s7 = function (action, arguments_0, state) {
    // Inline function 'kotlin.collections.mutableListOf' call
    var commands = ArrayList_init_$Create$();
    return commands;
  };
  var DootahScreen_com_example_jetnews_ui_post_FunctionalityNotAvailablePopup_instance;
  ...
  function DootahScreen_com_example_jetnews_ui_JetNewsLogo() {
    this.x7_1 = 'com.example.jetnews.ui.JetNewsLogo';
  }
  protoOf(DootahScreen_com_example_jetnews_ui_JetNewsLogo).r7 = function (arguments_0, state) {
  ...
  protoOf(DootahScreen_com_example_jetnews_ui_JetNewsLogo).s7 = function (action, arguments_0, state) {
    // Inline function 'kotlin.collections.mutableListOf' call
    var commands = ArrayList_init_$Create$();
    return commands;
  };
  var DootahScreen_com_example_jetnews_ui_JetNewsLogo_instance;
  function DootahScreen_com_example_jetnews_ui_JetNewsLogo_getInstance() {
  ...
  function DootahScreen_com_example_jetnews_ui_home_PostListTopSection() {
    this.z7_1 = 'com.example.jetnews.ui.home.PostListTopSection';
  }
  protoOf(DootahScreen_com_example_jetnews_ui_home_PostListTopSection).r7 = function (arguments_0, state) {
    // Inline function 'kotlin.collections.buildList' call
    // Inline function 'kotlin.collections.buildListInternal' call
    // Inline function 'kotlin.apply' call
    var this_0 = ArrayList_init_$Create$();
    this_0.f1(new ComponentNode('!androidx.compose.material3.Text@0ik0o6jgual8d'));
    this_0.f1(new ComponentNode('!com.example.jetnews.ui.home.PostCardTop@1bid0loc3t30e'));
    this_0.f1(new ComponentNode('com.example.jetnews.ui.home.PostListDivider()'));
    var tmp$ret$0 = this_0.a2();
    return new FragmentNode(tmp$ret$0);
  };
  protoOf(DootahScreen_com_example_jetnews_ui_home_PostListTopSection).s7 = function (action, arguments_0, state) {
    // Inline function 'kotlin.collections.mutableListOf' call
    var commands = ArrayList_init_$Create$();
    return commands;
  };
  var DootahScreen_com_example_jetnews_ui_home_PostListTopSection_instance;
  function DootahScreen_com_example_jetnews_ui_home_PostListTopSection_getInstance() {
  ...
  function DootahScreen_com_example_jetnews_ui_utils_ShareButton() {
    this.d8_1 = 'com.example.jetnews.ui.utils.ShareButton';
  }
  protoOf(DootahScreen_com_example_jetnews_ui_utils_ShareButton).r7 = function (arguments_0, state) {
    var tmp = mapOf(to('onClick', new CallbackProp('onClick()', 0)));
    // Inline function 'kotlin.collections.buildList' call
    // Inline function 'kotlin.collections.buildListInternal' call
    // Inline function 'kotlin.apply' call
  ...
  protoOf(DootahScreen_com_example_jetnews_ui_utils_ShareButton).s7 = function (action, arguments_0, state) {
    // Inline function 'kotlin.collections.mutableListOf' call
    var commands = ArrayList_init_$Create$();
    return commands;
  };
  var DootahScreen_com_example_jetnews_ui_utils_ShareButton_instance;
  function DootahScreen_com_example_jetnews_ui_utils_ShareButton_getInstance() {
  ...
  function DootahScreen_com_example_jetnews_ui_home_AuthorAndReadTime() {
    this.y7_1 = 'com.example.jetnews.ui.home.AuthorAndReadTime';
  }
  protoOf(DootahScreen_com_example_jetnews_ui_home_AuthorAndReadTime).r7 = function (arguments_0, state) {
    var tmp = listOf(Inherited_instance);
    // Inline function 'kotlin.collections.buildList' call
    // Inline function 'kotlin.collections.buildListInternal' call
    // Inline function 'kotlin.apply' call
  ...
  protoOf(DootahScreen_com_example_jetnews_ui_home_AuthorAndReadTime).s7 = function (action, arguments_0, state) {
    // Inline function 'kotlin.collections.mutableListOf' call
    var commands = ArrayList_init_$Create$();
    return commands;
  };
  var DootahScreen_com_example_jetnews_ui_home_AuthorAndReadTime_instance;
  function DootahScreen_com_example_jetnews_ui_home_AuthorAndReadTime_getInstance() {
  ...
  DootahScreen_com_example_jetnews_glance_ui_PostDescription_instance = new DootahScreen_com_example_jetnews_glance_ui_PostDescription();
  ...
  DootahScreen_com_example_jetnews_ui_home_PostCardTopPreviews_instance = new DootahScreen_com_example_jetnews_ui_home_PostCardTopPreviews();
  ...
  DootahScreen_com_example_jetnews_ui_JetNewsLogo_instance = new DootahScreen_com_example_jetnews_ui_JetNewsLogo();
  ...
  DootahScreen_com_example_jetnews_ui_home_AuthorAndReadTime_instance = new DootahScreen_com_example_jetnews_ui_home_AuthorAndReadTime();
  //endregion
...
throw new Error("Phase 6.2 acceptance C: initialization failed");
