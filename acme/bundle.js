...
(function (factory) {
  ...
  initMetadataForObject(DootahScreen_com_acme_shop_CartPanel, 'DootahScreen_com_acme_shop_CartPanel');
  initMetadataForObject(DootahScreen_com_acme_shop_ProductHeader, 'DootahScreen_com_acme_shop_ProductHeader');
  //endregion
  ...
  protoOf(ScreenArguments).q4 = function (name) {
  ...
  protoOf(ScreenArguments).r4 = function (name) {
  ...
  protoOf(ScreenState).u4 = function (name, value) {
    // Inline function 'kotlin.collections.set' call
    this.s4_1.o1(name, value);
  };
  function Inherited() {
  }
  ...
  protoOf(Padding).toString = function () {
    return 'Padding(start=' + this.v4_1 + ', top=' + this.w4_1 + ', end=' + this.x4_1 + ', bottom=' + this.y4_1 + ')';
  };
  protoOf(Padding).hashCode = function () {
    var result = getNumberHashCode(this.v4_1);
    result = imul(result, 31) + getNumberHashCode(this.w4_1) | 0;
    result = imul(result, 31) + getNumberHashCode(this.x4_1) | 0;
    result = imul(result, 31) + getNumberHashCode(this.y4_1) | 0;
    return result;
  };
  ...
  function FillMaxWidth(fraction) {
    this.z4_1 = fraction;
  }
  protoOf(FillMaxWidth).toString = function () {
    return 'FillMaxWidth(fraction=' + this.z4_1 + ')';
  };
  protoOf(FillMaxWidth).hashCode = function () {
    return getNumberHashCode(this.z4_1);
  };
  protoOf(FillMaxWidth).equals = function (other) {
    if (this === other)
      return true;
    if (!(other instanceof FillMaxWidth))
      return false;
  ...
  protoOf(ColumnNode).toString = function () {
    return 'ColumnNode(modifiers=' + toString_1(this.a5_1) + ', children=' + toString_1(this.b5_1) + ')';
  };
  protoOf(ColumnNode).hashCode = function () {
    var result = hashCode_0(this.a5_1);
  ...
  protoOf(NativeSlotNode).toString = function () {
    return 'NativeSlotNode(slot=' + this.c5_1 + ')';
  };
  ...
  protoOf(ButtonNode).toString = function () {
    return 'ButtonNode(text=' + this.h5_1 + ', action=' + this.i5_1 + ', modifiers=' + toString_1(this.j5_1) + ')';
  };
  protoOf(ButtonNode).hashCode = function () {
    var result = getStringHashCode(this.h5_1);
    result = imul(result, 31) + getStringHashCode(this.i5_1) | 0;
  ...
  function toJson_0(_this__u8e3s4) {
    ...
    if (_this__u8e3s4 instanceof ColumnNode) {
      tmp = container('column', _this__u8e3s4.a5_1, _this__u8e3s4.b5_1);
    } else {
      if (_this__u8e3s4 instanceof RowNode) {
        ...
        if (_this__u8e3s4 instanceof BoxNode) {
          tmp = container('box', _this__u8e3s4.k5_1, _this__u8e3s4.l5_1);
        } else {
          if (_this__u8e3s4 instanceof TextNode) {
            ...
            if (_this__u8e3s4 instanceof ButtonNode) {
              tmp = '{"type":"button","text":"' + escapeJson(_this__u8e3s4.h5_1) + '",' + ('"action":"' + escapeJson(_this__u8e3s4.i5_1) + '"') + modifiersField(_this__u8e3s4.j5_1) + '}';
            } else {
              if (_this__u8e3s4 instanceof NativeSlotNode) {
                tmp = '{"type":"native","slot":"' + escapeJson(_this__u8e3s4.c5_1) + '"}';
              } else {
                noWhenBranchMatchedException();
              }
            }
  ...
  function toJson_1(_this__u8e3s4) {
    ...
    if (_this__u8e3s4 instanceof Inherited) {
      ...
      if (_this__u8e3s4 instanceof Padding) {
        tmp = '{"type":"padding","start":' + _this__u8e3s4.v4_1 + ',"top":' + _this__u8e3s4.w4_1 + ',' + ('"end":' + _this__u8e3s4.x4_1 + ',"bottom":' + _this__u8e3s4.y4_1 + '}');
      } else {
        if (_this__u8e3s4 instanceof FillMaxWidth) {
          tmp = '{"type":"fillMaxWidth","fraction":' + _this__u8e3s4.z4_1 + '}';
        } else {
          if (_this__u8e3s4 instanceof FillMaxHeight) {
            tmp = '{"type":"fillMaxHeight","fraction":' + _this__u8e3s4.t5_1 + '}';
          } else {
            if (_this__u8e3s4 instanceof FillMaxSize) {
              tmp = '{"type":"fillMaxSize","fraction":' + _this__u8e3s4.s5_1 + '}';
            } else {
              if (_this__u8e3s4 instanceof Size) {
                tmp = '{"type":"size","width":' + _this__u8e3s4.q5_1 + ',"height":' + _this__u8e3s4.r5_1 + '}';
              } else {
                if (_this__u8e3s4 instanceof Width) {
                  tmp = '{"type":"width","value":' + _this__u8e3s4.p5_1 + '}';
                } else {
                  if (_this__u8e3s4 instanceof Height) {
                    tmp = '{"type":"height","value":' + _this__u8e3s4.o5_1 + '}';
                  } else {
                    if (_this__u8e3s4 instanceof Weight) {
                      tmp = '{"type":"weight","value":' + _this__u8e3s4.n5_1 + '}';
                    } else {
                      if (_this__u8e3s4 instanceof Background) {
                        tmp = '{"type":"background","color":' + _this__u8e3s4.m5_1.toString() + '}';
                      } else {
                        noWhenBranchMatchedException();
                      }
                    }
  ...
  function screenIds() {
    _init_properties_DootahExports_kt__7euayy();
    return screenIdsJson(listOf_0(['com.acme.shop.CartPanel', 'com.acme.shop.ProductHeader']));
  }
  ...
  function renderOf(screenId, arguments_0, state) {
    _init_properties_DootahExports_kt__7euayy();
    switch (screenId) {
      case 'com.acme.shop.CartPanel':
        return DootahScreen_com_acme_shop_CartPanel_instance.v5(arguments_0, state);
      case 'com.acme.shop.ProductHeader':
        return DootahScreen_com_acme_shop_ProductHeader_instance.v5(arguments_0, state);
      default:
        return null;
    }
  }
  function performOn(screenId, action, arguments_0, state) {
    ...
    switch (screenId) {
      case 'com.acme.shop.CartPanel':
        return DootahScreen_com_acme_shop_CartPanel_instance.x5(action, arguments_0, state);
      case 'com.acme.shop.ProductHeader':
        return DootahScreen_com_acme_shop_ProductHeader_instance.x5(action, arguments_0, state);
      default:
        return null;
    }
  }
  ...
  function DootahScreen_com_acme_shop_CartPanel() {
    this.u5_1 = 'com.acme.shop.CartPanel';
  }
  protoOf(DootahScreen_com_acme_shop_CartPanel).v5 = function (arguments_0, state) {
    var unitPrice = arguments_0.q4('unitPrice');
    state.t4('quantity', 1);
    ...
    this_0.f1(new NativeSlotNode('Text(color|text)#0'));
    ...
    this_1.f1(new ButtonNode('Add one', 'add-one'));
    this_1.f1(new ButtonNode('Remove one', 'remove-one'));
    var tmp$ret$4 = this_1.a2();
    this_0.f1(new RowNode(tmp_0, tmp$ret$4));
    this_0.f1(new ButtonNode('Checkout', 'checkout'));
    var tmp$ret$0 = this_0.a2();
    return new ColumnNode(tmp, tmp$ret$0);
  };
  protoOf(DootahScreen_com_acme_shop_CartPanel).x5 = function (action, arguments_0, state) {
    ...
    switch (action) {
      case 'add-one':
        state.u4('quantity', state.q4('quantity') + 1 | 0);
        break;
      case 'remove-one':
        state.u4('quantity', state.q4('quantity') - 1 | 0);
        break;
      case 'checkout':
        commands.f1(new InvokeCallback('onCheckout'));
        break;
    }
    return commands;
  };
  var DootahScreen_com_acme_shop_CartPanel_instance;
  function DootahScreen_com_acme_shop_CartPanel_getInstance() {
    return DootahScreen_com_acme_shop_CartPanel_instance;
  }
  function DootahScreen_com_acme_shop_ProductHeader() {
    this.w5_1 = 'com.acme.shop.ProductHeader';
  }
  protoOf(DootahScreen_com_acme_shop_ProductHeader).v5 = function (arguments_0, state) {
  ...
  protoOf(DootahScreen_com_acme_shop_ProductHeader).x5 = function (action, arguments_0, state) {
    // Inline function 'kotlin.collections.mutableListOf' call
    var commands = ArrayList_init_$Create$();
    var name = arguments_0.p4('name');
    var price = arguments_0.q4('price');
  ...
  var DootahScreen_com_acme_shop_ProductHeader_instance;
  function DootahScreen_com_acme_shop_ProductHeader_getInstance() {
    return DootahScreen_com_acme_shop_ProductHeader_instance;
  }
  ...
  DootahScreen_com_acme_shop_CartPanel_instance = new DootahScreen_com_acme_shop_CartPanel();
  DootahScreen_com_acme_shop_ProductHeader_instance = new DootahScreen_com_acme_shop_ProductHeader();
  //endregion
