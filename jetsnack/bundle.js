...
(function (factory) {
  ...
  protoOf(DootahScreen_com_example_jetsnack_ui_home_SortFiltersSection).z6 = function (arguments_0, state) {
    ...
    // Inline function 'kotlin.apply' call
    var this_1 = ArrayList_init_$Create$();
    this_1.f1(new ComponentNode('com.example.jetsnack.ui.home.SortFilters(onChanged|sortFilters|sortState)', mapOf_0([to('sortState', new StringProp(sortState)), to('onChanged', new HandleProp('onFilterChange'))])));
    var tmp$ret$4 = this_1.a2();
    this_0.f1(new ColumnNode(tmp, tmp$ret$4));
    var tmp$ret$0 = this_0.a2();
    return new FragmentNode(tmp$ret$0);
  };
